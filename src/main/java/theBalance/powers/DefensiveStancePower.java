...
// 代替敌人的正敏捷，每次攻击后获得格挡
public class DefensiveStancePower extends AbstractPower implements CloneablePowerInterface {
    public static final String POWER_ID = BalanceMod.makeID("DefensiveStancePower");
    ...
    public DefensiveStancePower(final AbstractCreature owner, int amount) {
        name = NAME;
        ID = POWER_ID;
        this.owner = owner;
        this.amount = amount;
