...
// 战斗津贴 - Combat Gold
// 战斗中的临时金币，战斗结束后消失
public class CombatGoldPower extends AbstractPower implements CloneablePowerInterface {
    public static final String POWER_ID = BalanceMod.makeID("CombatGoldPower");
    ...
    public AbstractPower makeCopy() {
        return new CombatGoldPower(owner, amount);
    }
}
