...
//TODO: DON'T MASS RENAME/REFACTOR
//TODO: DON'T MASS RENAME/REFACTOR
// Please don't just mass replace "theBalance" with "yourMod" everywhere.
...
// Scroll down in this file. Change the ID from "theBalance:" to "yourModName:" or whatever your heart desires (don't use spaces). Dw, you'll see it.
// In the JSON strings (resources>localization>eng>[all them files] make sure they all go "yourModName:" rather than "theBalance", and change to "yourmodname" rather than "thedefault".
...
@SpireInitializer
public class BalanceMod implements
        EditCardsSubscriber,
    ...
    public static Properties theBalanceDefaultSettings = new Properties();
    ...
    private static final String ATTACK_DEFAULT_GRAY = "theBalanceResources/images/512/bg_attack_default_gray.png";
    private static final String SKILL_DEFAULT_GRAY = "theBalanceResources/images/512/bg_skill_default_gray.png";
    private static final String POWER_DEFAULT_GRAY = "theBalanceResources/images/512/bg_power_default_gray.png";

    private static final String ENERGY_ORB_DEFAULT_GRAY = "theBalanceResources/images/512/card_default_gray_orb.png";
    private static final String CARD_ENERGY_ORB = "theBalanceResources/images/512/card_small_orb.png";

    private static final String ATTACK_DEFAULT_GRAY_PORTRAIT = "theBalanceResources/images/1024/bg_attack_default_gray.png";
    private static final String SKILL_DEFAULT_GRAY_PORTRAIT = "theBalanceResources/images/1024/bg_skill_default_gray.png";
    private static final String POWER_DEFAULT_GRAY_PORTRAIT = "theBalanceResources/images/1024/bg_power_default_gray.png";
    private static final String ENERGY_ORB_DEFAULT_GRAY_PORTRAIT = "theBalanceResources/images/1024/card_default_gray_orb.png";
    ...
    public static final String THE_DEFAULT_CORPSE = "theBalanceResources/images/char/defaultCharacter/corpse.png";

    //Mod Badge - A small icon that appears in the mod settings menu next to your mod.
    public static final String BADGE_IMAGE = "theBalanceResources/images/Badge.png";
    ...
    public BalanceMod() {
      ...
      */
        ...
        // 1. Go to your resources folder in the project panel, and refactor> rename theBalanceResources to
        // yourModIDResources.
        ...
        // replace all instances of theBalance with yourModID, and all instances of thedefault with yourmodid (the same but all lowercase).
        ...
        // Change their locations to reflect your actual ID rather than theBalance. They get loaded before getID is a thing.
        ...
        theBalanceDefaultSettings.setProperty(ENABLE_PLACEHOLDER_SETTINGS, "FALSE"); // This is the default setting. It's actually set...
        try {
            SpireConfig config = new SpireConfig("balanceMod", "theBalanceConfig", theBalanceDefaultSettings); // ...right here
...
//        SkinManager.registerSkin(alternateSkin2, false);
    ...
    public static void setModID(String ID) { // DON'T EDIT
        ...
        InputStream in = BalanceMod.class.getResourceAsStream("/IDCheckStringsDONT-EDIT-AT-ALL.json"); // DON'T EDIT THIS ETHER
    ...
    private static void pathCheck() { // ALSO NO
        ...
        InputStream in = BalanceMod.class.getResourceAsStream("/IDCheckStringsDONT-EDIT-AT-ALL.json"); // DON'T EDIT THISSSSS
        IDCheckDontTouchPls EXCEPTION_STRINGS = coolG.fromJson(new InputStreamReader(in, StandardCharsets.UTF_8), IDCheckDontTouchPls.class); // NAH, NO EDIT
        String packageName = BalanceMod.class.getPackage().getName(); // STILL NO EDIT ZONE
    ...
    public static void initialize() {
        ...
        BalanceMod defaultmod = new BalanceMod();
    ...
    public void receivePostInitialize() {
        ...
        ModLabeledToggleButton enableNormalsButton = new ModLabeledToggleButton("This is the text which goes next to the checkbox.",
            ...
            try {
                ...
                SpireConfig config = new SpireConfig("defaultMod", "theBalanceConfig", theBalanceDefaultSettings);
...
//        UnlockTracker.markRelicAsSeen(BottledPlaceholderRelic.ID);
    ...
    // Helper method to check if a card is a Mirror card
    public static boolean isMirrorCard(com.megacrit.cardcrawl.cards.AbstractCard card) {
        if (card == null) return false;
        String cardID = card.cardID;
        return cardID.equals(makeID("MirrorProjection")) ||
               cardID.equals(makeID("MirrorShield")) ||
               cardID.equals(makeID("MirrorSoul")) ||
               cardID.equals(makeID("MirrorBarrier"));
    }
